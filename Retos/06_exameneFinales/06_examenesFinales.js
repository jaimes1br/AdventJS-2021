...
/**
 * 
 * @param {Array} numbers Números disponibles para encontrar la suma esperada
 * @param {Number} result Número esperado 
 * @returns {Array} Dos números que sumados nos dan result 
 */
