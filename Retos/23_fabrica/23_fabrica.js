 ...
 * un regalo pueda pasar a fabricar otro según las reglas mencionadas. Lo mejor es que 
 * veamos un ejemplo:
...
console.log(( ':------------------------------------------------------------------:').length)
console.log(('¿Vale la pena la tarjeta fidelidad del cine?'.length))
console.log(('¿Puedes reconfigurar las fábricas para no parar de crear regalos?').length)
/**
 * 
 * @param {String} from Palabra orginal
 * @param {String} to Palabra a cambiar
 * @returns {Boolean}  true: en caso de poder cambiar, else: en caso contrario
 */
