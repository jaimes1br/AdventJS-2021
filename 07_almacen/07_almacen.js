 ...
 * Vamos a crear una función contains que recibe dos parámetros: un objeto que 
 * define el almacén y el producto que buscamos.
 * La función debe devolver un booleano que indique si se encuentra el string como
 *  valor en algún nivel del objeto. Veamos unos ejemplos:
...
/**
 * 
 * @param {Object} store Contiene la estructura de la tienda o almace
 * @param {String} product Producto que vamos a buscar dentro del almacen
 * @returns {Boolean} true: si encontramos el producto, false en caso contrario
 */
